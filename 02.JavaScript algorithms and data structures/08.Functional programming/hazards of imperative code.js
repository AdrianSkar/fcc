...
Window.prototype.tabClose = function (index) {
	...
	this.tabs = this.tabs.filter((item, i) => item[i] !== item[index]);
...
Window.prototype.tabCloseFCC = function (index) {

	// Only change code below this line

	var tabsBeforeIndex = this.tabs.slice(0, index);
	var tabsAfterIndex = this.tabs.slice(1); // Takes advantage of the fact that the original array was modified and omits 0 and "pushes" from 1 until end avoiding the closed value (index at first, 0 after).
