...
let ratingsF = watchList.map(item => ({// wrapped between parentheses or it'll interpret code instead of returning an object
	title: item["Title"],
...
let ratingsFb = watchList.map(({ Title: title, imdbRating: rating }) => ({ title, rating }));


console.log(JSON.stringify(ratingsF));
console.log(JSON.stringify(ratingsFb));
